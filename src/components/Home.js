      ...
      <div class="content2">
        <div class="main-text2">
          ...
          <div class="text-group">
            <p class="text2">
              WE HELP TO GET THE
              <span class="highlight"> BEST CREATIVE SOLUTIONS</span> FOR YOUR
              <br />
              SPACE
            </p>
            <p class="text3">
              ...
              office building or even a coffee corner. we deeply believe that
              good design can make your life and <br />
        ...
        <div class="images">
          ...
          >
            <img
              src={`${process.env.PUBLIC_URL}/images/image10.png`}
              alt="DINING & KITCHEN"
            />
          ...
          >
            <img
              src={`${process.env.PUBLIC_URL}/images/image9.png`}
              alt="DINING & KITCHEN"
            />
      ...
      <div class="content3">
        ...
        <div class="images">
          <div onclick="enlargeImage('Images/image 11.png', 'BATHROOM', 'Aestethic bathroom design.')">
            <img
              src={`${process.env.PUBLIC_URL}/images/image11.png`}
              alt="DINING & KITCHEN"
            />
          ...
          <div onclick="enlargeImage('Images/image 12.png', 'LIVING ROOM', 'A simplistic living room design.')">
            <img
              src={`${process.env.PUBLIC_URL}/images/image12.png`}
              alt="DINING & KITCHEN"
            />
          ...
          <div onclick="enlargeImage('Images/image 15.png', 'DINING ROOM', 'A contemporary Dining room design.')">
            <img
              src={`${process.env.PUBLIC_URL}/images/image15.png`}
              alt="DINING & KITCHEN"
            />
        ...
        <div class="columns">
          <div>
            ...
            <div class="image-button">
              <div class="image">
                <img
                  src={`${process.env.PUBLIC_URL}/images/image16.png`}
                  alt="DINING & KITCHEN"
                />
              </div>
              <a href="Contact.html">
            ...
            <div class="boxes">
              ...
              <div class="box">
                <div class="boxbox">
                  ...
                  <ul class="items">
                    <li>
                      If you're not sure about your space deisgn feel free to
                      book an hour in office or online with us. during the
                      session we provide with sketches and solutions that fits
                      your needs
                    </li>
                  </ul>
                </div>
