    ...
    <>
      <div ref={flickityRef} className="main-carousel">
        <div class="carousel-cell">
          <img src={process.env.PUBLIC_URL + "/images/Project6/P1.jpg"} />
        </div>
        <div class="carousel-cell">
          <img src={process.env.PUBLIC_URL + "/images/Project6/P2.jpg"} />
        </div>
        <div class="carousel-cell">
          <img src={process.env.PUBLIC_URL + "/images/Project6/P3.jpg"} />
        </div>
        <div class="carousel-cell">
          <img src={process.env.PUBLIC_URL + "/images/Project6/P4.jpg"} />
        </div>
        <div class="carousel-cell">
          <img src={process.env.PUBLIC_URL + "/images/Project6/P5.jpg"} />
        </div>
        <div class="carousel-cell">
          <img src={process.env.PUBLIC_URL + "/images/Project6/P6.jpg"} />
        </div>
      </div>
      ...
      <div class="Project">
        <div class="Project-Image">
          ...
          >
            <img src={process.env.PUBLIC_URL + "/images/Project6/P7.jpg"} />
          </div>
          ...
          >
            <img src={process.env.PUBLIC_URL + "/images/Project6/P8.jpg"} />
          </div>
